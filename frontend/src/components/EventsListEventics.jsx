            ...
            <div className="mx-auto px-[12px] max-w-[1200px] xl:max-w-full">
                ...
                {catLoading || eventsLoading ? (
                    ...
                    events.map((event, index) => {
                        ...
                        return (
                            <div key={index} className="relative flex flex-nowrap opacity-1 lg:flex-wrap items-center gap-[40px] py-[30px] border-b border-[#8E8E93]/25 rev-slide-up">
                                <div
                                ...
                                <div className="flex items-center gap-[78px] lg:gap-[38px] grow min-w-0">
                                    <div className="min-w-0">
                                        <h3 className="truncate mb-[11px] cursor-pointer font-semibold text-[30px] text-etBlack hover:text-etBlue transition-all duration-300 tracking-[-1px] anim-text">
