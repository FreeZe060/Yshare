...
import eventBgImage from "../../assets/img/banner-bg.jpg";
...
function BannerSection() {
    ...
    return (
        <section class="et-3-banner relative bg-gradient-to-b from-[#550ECA] to-[#F929BB] bg-cover bg-center " style={{ backgroundImage: `url(${eventBgImage})` }}>
            <div class="bg-no-repeat w-full h-full bg-cover bg-center pt-[clamp(20px,8.3vw,160px)] pb-[clamp(20px,8.3vw,160px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:opacity-50 before:bg-gradient-to-b before:from-[#550ECA] before:to-[#F929BB] before:-z-[1]">
