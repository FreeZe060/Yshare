 ...
 * GET /participants
 */
export async function getAllParticipantsForAdmin() {
 ...
 */
export async function getParticipantByIndex(eventId, index) {
 ...
 */
export async function addParticipant(eventId) {
	const response = await fetch(`${API_BASE_URL}/events/${eventId}/participants`, {
		method: 'POST',
		credentials: 'include',
		headers: {
 ...
 */
export async function updateParticipantStatus(eventId, index, status) {
	const response = await fetch(`${API_BASE_URL}/events/${eventId}/participants/${index}`, {
		method: 'PUT',
		credentials: 'include',
		headers: {
 ...
 */
export async function removeParticipant(eventId, index) {
	const response = await fetch(`${API_BASE_URL}/events/${eventId}/participants/${index}`, {
		method: 'DELETE',
		credentials: 'include',
		headers: {
 ...
 */
export async function getUserEventsAdmin(userId) {
