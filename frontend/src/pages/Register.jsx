            ...
            <div className="h-screen flex flex-row md:flex-col">
                ...
                <div className="flex w-1/2 md:w-full justify-center items-center bg-white p-8">
                    <form
                        ...
                        className="bg-white flex w-full max-w-4xl flex-col animate__animated animate__fadeIn"
                    >
                        <h1 className="text-gray-800 font-bold text-5xl mb-4 text-center">
                            CRÉER UN COMPTE
                        </h1>
                        ...
                        <div className="flex items-center border-2 py-6 px-6 rounded-3xl mb-6 w-full">
                            <svg
                            ...
                            >
                                <path
                                    ...
                                    strokeWidth="2"
                                    d="M5.121 17.804A8.966 8.966 0 0112 15c2.485 0 4.72.908 6.879 2.404M15 11a3 3 0 11-6 0 3 3 0 016 0z"
                                />
                            </svg>
                            <input
                                className="pl-4 pr-4 outline-none border-none w-full text-2xl !bg-transparent"
                                type="text"
                                name="name"
                                placeholder="PRÉNOM"
                                value={name}
                        ...
                        <div className="relative flex items-center border-2 py-6 px-6 rounded-3xl mb-6 w-full">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-8 w-8 text-gray-400"
                                fill="none"
                            ...
                            >
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth="2"
                                    d="M12 11c0-1.657-1.343-3-3-3S6 9.343 6 11m6 0c0 1.657 1.343 3 3 3s3-1.343 3-3m-9 0v1a1 1 0 001 1h2a1 1 0 001-1v-1"
                                />
                            </svg>
                            <input
                            ...
                            >
                                ...
                                >
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth="2"
                                    d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10a9.959 9.959 0 014.073-7.073m2.156-1.84A9.953 9.953 0 0112 3c5.523 0 10 4.477 10 10 0 1.364-.27 2.657-.764 3.855"
                                    />
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                        ...
                        {error && (
                            <p className="text-center mt-4 text-red-500 text-2xl">{error}</p>
                        )}

                        <button
                            type="submit"
                            disabled={loading}
                            className="block w-full bg-indigo-600 py-6 px-6 rounded-3xl text-white font-semibold mb-6 transition transform hover:scale-105 text-2xl"
                        >
