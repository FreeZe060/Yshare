            ...
            <main>
                <section className="z-[1] before:-z-[1] before:absolute relative before:inset-0 bg-[#000D83] before:bg-cover before:bg-no-repeat before:bg-center before:opacity-30 pt-[210px] sm:pt-[160px] lg:pt-[190px] pb-[130px] sm:pb-[80px] lg:pb-[110px] et-breadcrumb">
                    <div className="mx-auto px-[12px] max-w-[1200px] xl:max-w-full text-white text-center container">
                        <h1 className="font-medium text-[56px] xs:text-[45px] md:text-[50px] et-breadcrumb-title">Notre Team</h1>
                            ...
                            <div className="justify-center gap-[30px] lg:gap-[20px] grid grid-cols-3 xxs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                                <div className="group et-member">
                                    ...
                                    <div className="before:-top-[33px] before:left-0 z-[1] before:-z-[1] before:absolute relative bg-white before:bg-white shadow-[0_4px_60px_rgba(18,96,254,0.12)] mx-[25px] xs:mx-[5px] md:mx-[15px] -mt-[44px] xs:mt-0 md:-mt-[15px] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] rounded-[16px] before:rounded-[16px] before:w-full before:h-full before:skew-y-[4deg] et-member__txt">
                                        ...
                                        <h5 className="mb-[4px] font-semibold text-[22px] text-etBlack md:text-[20px]"><a href="team-member-details.html" className="hover:text-etBlue">ROLLAND Dylan</a></h5>
                                        <span className="text-[16px] text-etGray">Chef de Projet (Cybersécurité)</span>
                                    </div>
                                </div>
                                ...
                                <div className="group et-member">
                                    ...
                                    <div className="before:-top-[33px] before:left-0 z-[1] before:-z-[1] before:absolute relative bg-white before:bg-white shadow-[0_4px_60px_rgba(18,96,254,0.12)] mx-[25px] xs:mx-[5px] md:mx-[15px] -mt-[44px] xs:mt-0 md:-mt-[15px] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] rounded-[16px] before:rounded-[16px] before:w-full before:h-full before:skew-y-[4deg] et-member__txt">
                                        ...
                                        <h5 className="mb-[4px] font-semibold text-[22px] text-etBlack md:text-[20px]"><a href="team-member-details.html" className="hover:text-etBlue">ISNARD Sacha</a></h5>
                                        <span className="text-[16px] text-etGray">Cybersécurité</span>
                                    </div>
                                </div>
                                ...
                                <div className="group et-member">
                                    ...
                                    <div className="before:-top-[33px] before:left-0 z-[1] before:-z-[1] before:absolute relative bg-white before:bg-white shadow-[0_4px_60px_rgba(18,96,254,0.12)] mx-[25px] xs:mx-[5px] md:mx-[15px] -mt-[44px] xs:mt-0 md:-mt-[15px] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] rounded-[16px] before:rounded-[16px] before:w-full before:h-full before:skew-y-[4deg] et-member__txt">
                                        ...
                                        <h5 className="mb-[4px] font-semibold text-[22px] text-etBlack md:text-[20px]"><a href="team-member-details.html" className="hover:text-etBlue">GONZALEZ Anthony</a></h5>
                                        <span className="text-[16px] text-etGray">Cybersécurité</span>
                                    </div>
                                </div>
                                ...
                                <div className="group et-member">
                                    <div className="rounded-[16px] overflow-hidden et-member__img">
                                        <img src="http://localhost:8080/profile-images/1744640026597-177124585.png" className="w-full group-hover:scale-110 duration-[400ms]" />
                                    </div>
                                    ...
                                    <div className="before:-top-[33px] before:left-0 z-[1] before:-z-[1] before:absolute relative bg-white before:bg-white shadow-[0_4px_60px_rgba(18,96,254,0.12)] mx-[25px] xs:mx-[5px] md:mx-[15px] -mt-[44px] xs:mt-0 md:-mt-[15px] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] rounded-[16px] before:rounded-[16px] before:w-full before:h-full before:skew-y-[4deg] et-member__txt">
                                        ...
                                        <h5 className="mb-[4px] font-semibold text-[22px] text-etBlack md:text-[20px]"><a href="team-member-details.html" className="hover:text-etBlue">HADDADA Yassine</a></h5>
                                        <span className="text-[16px] text-etGray">Cybersécurité</span>
                                    </div>
                                </div>
